                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-9">
                                ...
                                @if($products->qty > 0)
                                    ...
                                    {{-- <button type="button" class="btn btn-primary me-3 float-start"><a href="{{url('/add-to-cart/'.$products->id)}}">Add to Cart <i class="fa fa-shopping-cart"></i></a></button> --}}
                                    {{-- <button type="button" class="btn btn-primary me-3 addToCartBtn float-start">Add to Cart <i class="fa fa-shopping-cart"></i></button> --}}
                                @endif
                                <br>
                                <form action="{{url('add-to-wishlist/'.$products->id)}}" method="POST">
                                    @csrf
                                        <input type="hidden" value="1" min="1" class="form-control" style="width:100px" name="product_qty">
