...
<body class="bg-gray-200">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('asset('images/1660950115.jpg');">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a target="_blank" href="https://www.facebook.com" class="font-weight-bold text-white" target="_blank">Gustave Yobo.</a>
              </div>
            </div>
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a target="_blank" href="https://www.facebook.com" class="nav-link text-white" target="_blank">Gustave Yobo</a>
                </li>
                <li class="nav-item">
